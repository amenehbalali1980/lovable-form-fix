...
<style>
  .no-print { margin: 12px; text-align: center; display: flex; gap: 8px; justify-content: center; flex-wrap: wrap;}
  .no-print button {
...
<body>
      <div class="no-print">
  <button type="button" onclick="window.print()">چاپ / اشتراک‌گذاری</button>
